...
const projects = [
  {
    id: 7,
    title: 'Vensoni',
    description: 'AI Powered customer service for businesses and organizations',
    category: 'Web Application',
    technologies: ['React', 'Next.js', 'Typescript'],
    image: '/asset/imgs/vensoni-screenshot.png',
    link: 'https://vensoni.com/',
    github: '#',
    featured: true,
    year: '2026',
    color: '#9c27b0',
  },
  {
    id: 8,
    title: 'Yona',
    description: 'Tax Invoicing Platform for Nigerian Businesses',
    category: 'Web Application',
    technologies: ['React', 'Next.js', 'Typescript'],
    image: '/asset/imgs/yona-screenshot.png',
    link: 'https://useyona.com/',
    github: '#',
    featured: true,
    year: '2026',
    color: '#9c27b0',
  },
  {
    id: 7,
    title: 'CampusWave',
    description: 'Social media platform for Nigerian Universities',
    category: 'Web Application',
    technologies: ['React', 'Next.js', 'Typescript'],
    image: '/asset/imgs/wavesocial-screenshot.png',
    link: 'https://wavesocial.com.ng/',
    github: '#',
    featured: true,
    year: '2025',
    color: '#9c27b0',
