...
const CareerCard = ({
  ...
  return (
    <motion.div
      ...
      className={`relative rounded-xl bg-neutral-900/10 dark:bg-neutral-800/30 overflow-hidden hover:bg-neutral-900/20 dark:hover:bg-neutral-800/50 transition-all duration-300`}
    >
      <div className="p-6 space-y-6">
        ...
        >
          {technologies.map((tech) => (
            <span
              key={tech}
              className="px-3 py-1 rounded-full text-xs bg-neutral-900/20 dark:bg-neutral-800/50 text-muted-foreground"
            >
              {tech}
            </span>
          ))}
