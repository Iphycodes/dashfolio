...
interface MigrateItmeModalProps {
...
const MigrateItemModal = ({
  item,
  handlePromoteItem,
  isLoadingPromoteItem,
  environment,
  service
}: MigrateItmeModalProps) => {
  ...
  return (
    <div className="w-full">
      <div className="font-bold text-[24px] mb-3">Migrate Item</div>
      <div
...
export default MigrateItemModal;
